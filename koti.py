...
def main(session_state):
    ...
    st.write(
        f"""
        <div class="base-wrapper" style="background-color:#022B7E; margin: 0rem 22rem; transform: rotate(90deg); background-image: url({image_to_bytes('images/main_logo-03.png', 0)}); background-size: 850px; opacity:1; background-repeat: no-repeat;
